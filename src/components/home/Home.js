            ...
            <div className='home'>
                ...
                <div className='top'>
                    ...
                    <MediaQuery query="(min-width: 750px)">
                        <video className='loop' autoplay='autoplay' loop='loop' muted='true' playsinline fullscreen='false' poster="http://euonthemove.eu/wp-content/uploads/2017/05/no-video.jpg"> controls>
